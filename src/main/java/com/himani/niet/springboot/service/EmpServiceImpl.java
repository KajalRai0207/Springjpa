...
import com.himani.niet.springboot.repository.EmployeeRepository;
...
public class EmpServiceImpl implements EmpService {
    ...
    public void addEmployee() {
        ...
        for(int i=0; i<emp.size(); i++) {
        	 employeeRepository.save(emp.get(i));
        }
    }
	...
	@Override
	public void updateEmployeeCity(long id, String city) {
		employeeRepository.updateEmployeeCity(city, id);
